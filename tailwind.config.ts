  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        /* Novo: ticker de preço a piscar */
        "price-flash-up": {
          "0%":   { color: "hsl(var(--success))", backgroundColor: "hsl(var(--success) / 0.15)" },
          "100%": { color: "inherit", backgroundColor: "transparent" },
        },
        "price-flash-down": {
          "0%":   { color: "hsl(var(--destructive))", backgroundColor: "hsl(var(--destructive) / 0.15)" },
          "100%": { color: "inherit", backgroundColor: "transparent" },
        },
        /* Novo: entrada suave de cards */
        "slide-up": {
          "0%":   { opacity: "0", transform: "translateY(16px)" },
          "100%": { opacity: "1", transform: "translateY(0)" },
        },
        /* Novo: ponto a piscar (live indicator) */
        "blink": {
          "0%, 100%": { opacity: "1" },
          "50%":      { opacity: "0" },
        },
