...
/**
 * Aplica as preferências do utilizador. O nível de volatilidade NÃO esconde
 * janelas — apenas destaca as do nível escolhido (ordenação). Todos os BOOMs
 * activos continuam sempre visíveis.
 */
