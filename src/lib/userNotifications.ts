 ...
 */
export async function fetchUserNotifications(limit = NOTIFICATIONS_LIMIT): Promise<UserNotification[]> {
...
/**
 * Variante paginada de fetchUserNotifications: devolve a mesma shape
 * (UserNotification[]) mas usando range() para páginas de pageSize.
 * page é 0-based.
 */
